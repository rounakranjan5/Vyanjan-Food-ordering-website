...
const RestaurentCard=(props)=>{
    ...
    return (
        <div className="text-center m-5  p-3 rounded-xl max-md:w-[290px]  md:w-[250px] lg:w-[320px] bg-indigo-100 hover:bg-red-950 hover:text-white cursor-pointer hover:scale-105 transition-all duration-30">
